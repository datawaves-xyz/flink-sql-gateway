...
RUN curl -s "https://repo1.maven.org/maven2/org/apache/flink/flink-connector-kafka_2.12/1.12.7/flink-connector-kafka_2.12-1.12.7.jar"  \
    -o "/opt/flink/flink-sql-gateway/lib/flink-connector-kafka_2.12-1.12.7.jar"
